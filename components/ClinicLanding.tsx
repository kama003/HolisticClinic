  ...
  return (
    <div className="min-h-screen pb-20 bg-[#f2f2f2]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between bg-[#f2f2f2]/40 backdrop-blur-xl rounded-full px-8 py-3 neumorphic-button border border-white/20">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-bold text-sm leading-tight text-[#2c3e2c]">Chandigarh</h1>
              <p className="text-[10px] opacity-60 text-[#2c3e2c]">holistic clinic</p>
            </div>
          </div>
          
          <div className="hidden md:flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-[#2c3e2c]">
          ...
          <button 
            ...
            className="px-6 py-2 rounded-full neumorphic-button text-[10px] font-bold uppercase tracking-widest text-[#2c3e2c]"
          >
            Log In | Sign Up
          </button>
        </div>
      ...
      <section id="home" className="pt-48 pb-20 px-6 relative">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-12">
          ...
          >
            <h2 className="text-6xl md:text-8xl font-black text-[#2c3e2c] leading-[0.95] mb-10 tracking-tighter">
              Nature Has A <br />
              Way of <br />
              Living. <br />
              Consult us <br />
          ...
          >
            ...
            {/* Decorative elements */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] border border-[#6b8e6b]/5 rounded-full -z-10" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] border border-[#6b8e6b]/10 rounded-full -z-10" />
          </motion.div>
        </div>
      </section>
      ...
      <section id="about" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="neumorphic-card rounded-[40px] p-12 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-64 h-64 rounded-full overflow-hidden border-8 border-[#f2f2f2] shadow-xl">
              <img 
      ...
      <section id="testimonials" className="py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className="text-3xl font-bold mb-16 text-[#2c3e2c]">Testimonials</h3>
            ...
            <div className="w-full max-w-3xl mx-auto relative overflow-hidden py-6 px-4">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative z-10">
                    <p className="text-xl italic mb-8 text-[#4a634a] leading-relaxed font-medium">
                      {testimonials[currentTestimonial].text}
                    </p>
                    <p className="font-bold text-base text-[#2c3e2c] tracking-wide">
            ...
            {testimonials.map((_, idx) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all duration-500 ${
                  idx === currentTestimonial ? 'bg-[#6b8e6b] scale-125' : 'bg-[#6b8e6b]/20'
                }`}
              />
            ))}
          </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-[#2c3e2c]">Welcome Back</h3>
                <p className="text-sm opacity-60 text-[#2c3e2c]">Please enter your details to continue</p>
              </div>

              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#2c3e2c] ml-4">Email Address</label>
                  <input 
                    type="email" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-[#2c3e2c] ml-4">Password</label>
                  <input 
                    type="password" 
                    placeholder="••••••••" 
                    className="w-full px-6 py-4 rounded-2xl neumorphic-inset text-sm outline-none focus:ring-2 ring-[#6b8e6b]/20 transition-all"
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                    <span className="bg-[#f2f2f2] px-4 text-[#2c3e2c]/40">Or continue with</span>
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <button className="py-3 rounded-2xl neumorphic-button text-[10px] font-bold uppercase tracking-widest text-[#2c3e2c] flex items-center justify-center gap-2">
              ...
              <p className="text-center mt-8 text-[11px] text-[#2c3e2c]/60">
